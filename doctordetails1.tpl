...
<head>
    ...
    <link href="admin/admin/assets/css/lib/data-table/buttons.bootstrap.min.css" rel="stylesheet" />
        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <div class="logo"><a href="index.php"><!-- <img src="assets/images/logo.png" alt="" /> --><span>Disease Prediction System</span></a></div>
                    <ul>
                        ...
                        <!-- </li> -->
                         ...
                         <li><a href="adminmainheader.php">Home</a></li>
                         <li class="label">Contents</li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Complaint <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="admincomplaintview.php">Complaints</a></li>
                        ...
                        <!-- </li> -->
                       <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> USERS <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                <!-- <li><a href="docdetails.php"class="fa fa-user-md"> DOCTOR</a></li> -->
                               
                                <li><a href="patientdetails.php" class="fa fa-wheelchair"> PATIENT</a></li>
                                <li><a href="labdetailsadmin.php" class="fa fa-medkit"> LAB</a></li>
                               </ul>
                        </li>
...
<!--                                 <li><a href="vector-map.html">Vector Map</a></li>
    ...
    <div class="content-wrap">
        <div class="main">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <!-- <h1>Hello, <span>Welcome Adm</span></h1> -->
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
            ...
            {if $data.status==0}
            <td><a href="doctorapprove.php?key={$data.loginid}"class="btn btn-success">APPROVE</a></td>
            <td><a href="doctorreject.php?key={$data.loginid}" class="btn btn-danger">REJECT</a></td></tr>
             ...
             {/if}
                {/foreach}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>2022 © Dept of CAS students IHRD KUNDARA. - <a href="caskundara.ihrd.ac.in">caskundara.ihrd.ac.in</a></p>
                            </div>
                        </div>
                    </div>
                </section>
