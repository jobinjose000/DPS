 ...
 -->
    ...
    <div class="content-wrap">
        <div class="main">
            ...
            {if $data.status==0}
            <td><a href="labapprove.php?key={$data.loginid}"class="btn btn-success">APPROVE</a></td>
            <td><a href="labreject.php?key={$data.loginid}" class="btn btn-danger">REJECT</a></td></tr>
