<html>
<head>
	<title>doctordetails</title></head>
	<body>
...
<body>
        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <div class="logo"><a href="index.php"><!-- <img src="admin/assets/images/logo.png" alt="" /> --><span>Disease Prediction System</span></a></div>
                    <ul>
    ...
    <div class="header">
        <div class="container-fluid">
			...
			<td><a href="doctorapprove.php?key={$data.logkey}">APPROVE</a></td>
			<td><a href="doctorreject.php?key={$data.logkey}">REJECT</a></td></tr>
				{/foreach}
                                            </tbody>
                                            <thead>
                                                <tr>
