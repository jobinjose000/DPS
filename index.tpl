...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Disease Prediction & Online Appointment System</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->              
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="index.html"><i class="fa fa-heartbeat"></i>Disease Prediction System</span></a>              
              <!-- IMG BASED LOGO  -->
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li class="dropdown">
                  <a href="#" class="btn btn-success dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">REGISTRATIONS <span class="fa fa-angle-down"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="docreg.php" class="dropdown-item">Doctor Registration</a></li>
                    <li><a href="userreg.php" class="dropdown-item">User Registration</a></li>
                     <li><a href="labreg.php" class="dropdown-item">Lab Registration</a></li>
                  </ul></li>
                <li><a href="logintemplate.php"><button type="submit" class="btn navbar-btn btn-success" name="login" id="login" value="Log-In">LOG-IN</button></a></li>
                <!-- <li><a href="docprofile.php">PROFILE</a></li>
                <li><a href="about-us.html">About Us</a></li> -->
                <!-- <li class="dropdown">
                  <a href="#" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">REGISTRATIONS <span class="fa fa-angle-down"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="docreg.php" class="dropdown-item">Doctor Registration</a></li>
                    <li><a href="userreg.php" class="dropdown-item">User Registration</a></li></ul></li> -->
              </ul>           
            </div><!--/.nav-collapse -->
          </div>     
        </nav>  
      ...
      <div class="top-slider">
        ...
        <div class="top-slide-inner">
          <div class="slider-img">
            ...
            <p><strong>Disease Prediction &</strong> Online Appointment System</p>
          <div class="slider-text">
            <h2><strong>Disease Prediction &</strong>Online Appointment System</h2>
        ...
        <div class="top-slide-inner">
          <div class="slider-img">
            <img src="user/images/12.user/" alt="">
          </div>
          <div class="slider-text">
            <h2><strong>Best Template</strong> For your Medical Website</h2>
            <p><strong>Disease Prediction &</strong> Online Appointment System</p>
                ...
                <div class="whyChoose-left">
                  <div class="whychoose-slider">
                    <div class="whychoose-singleslide">
                      <img src="user/images/choose-us-img1.jpg" alt="img">
                    </div>
                    <div class="whychoose-singleslide">
                      <img src="user/images/choose-us-img2.jpg" alt="img">
                    </div>
                    <div class="whychoose-singleslide">
                      <img src="user/images/choose-us-img3.jpg" alt="img">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <ul class="doctors-nav">
                  <li>
                    <div class="single-doctor">
                      <a class="tdoctor" href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                          <img src="user/images/doctor-1.jpg" />
                  ...
                  <li>
                    <div class="single-doctor">
                      ...
                      <a class="tdoctor" href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                          <img src="user/images/doctor-2.jpg" />
                          <svg viewBox="0 0 180 320" preserveAspectRatio="none"><path d="M 180,160 0,218 0,0 180,0 z"/></svg>
                          <figcaption>
                  ...
                  <li>
                    <div class="single-doctor">
                      ...
                      <a class="tdoctor" href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                          <img src="user/images/doctor-3.jpg" />
                          <svg viewBox="0 0 180 320" preserveAspectRatio="none"><path d="M 180,160 0,218 0,0 180,0 z"/></svg>
                          <figcaption>
                  ...
                  <li>
                    <div class="single-doctor">
                      ...
                      <a class="tdoctor" href="#" data-path-hover="m 180,34.57627 -180,0 L 0,0 180,0 z">
                        <figure>
                          <img src="user/images/doctor-5.jpg" />
                          <svg viewBox="0 0 180 320" preserveAspectRatio="none"><path d="M 180,160 0,218 0,0 180,0 z"/></svg>
                          <figcaption>
                  ...
                  <li>
                    <div class="single-testimonial">
                      <div class="testimonial-img">
                        <img src="user/images/patients-3.jpg" alt="img">
                      </div>
