            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.php">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span>Disease Prediction System</span></a></div>
                   ...
                   <!--  <li><a href="app-email.html"><i class="ti-email"></i> Email</a></li> -->
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> USERS <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                           

                         <li><a href="docdetails.php" class="fa fa-user-md">  DOCTOR</a></li>
                            <li><a href="patientdetails.php" class="fa fa-wheelchair"> PATIENTS </a></li>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="pull-left m-r-10 avatar-img"
                                                        src="admin/assets/images/avatar/3.jpg" alt="" />
