          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="labprofile.php">Profile</a></li>
                ...
                <li><a href="labappointmentview.php">Appointments</a></li>
                <li><a href="reports.php">Reports</a></li>
                <li><a href="testamount.php">Test Amount</a></li>
                <!-- <li class="">
                  <a href="#" class="" data-toggle="">Appointment <span class="fa fa-angle-down"></span></a> -->
                  <!-- <ul class="dropdown-menu" role="menu"> -->
                    <!-- <li><a href="appointment.php">Fix appointment</a></li>
      ...
      <div class="top-slider">
        ...
        <div class="top-slide-inner">
          ...
          <div class="slider-text">
            ...
            <p><strong>Disease Prediction</strong> And Online Appointment System</p>
