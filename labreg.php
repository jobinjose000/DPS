                ...
                if(isset($_POST['email'])AND($_POST['email'])!=NULL)
                  {
                    ...
                    if(isset($_POST['password'])AND($_POST['password'])!=NULL)
                    {
                      ...
                      $timeto=trim($_POST['timeto']);
     									...
     									$obj->labregistration($name,$address,$pincode,$district,$city,$contactno,$days,$timefrom,$timeto,$email,$password);
     									}
     									else
                     ...
                     echo"<script>alert('enter the available time')</script>";
                 }
                 else
                  echo"<script>alert('enter the available time')</script>";
              }
              else 
                echo"<script>alert('enter the available days')</script";
     							}
                  else
