...
<html lang="en">
  <head>
    <!--=============================================== 
    Template Design By  reeware Team.
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->              
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="index.php"><i class="fa fa-user-md"></i>Disease <span>Prediction system</span></a>              
              <!-- IMG BASED LOGO  -->
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Messages <span class="fa fa-angle-down"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="receivemessage.php">Inbox</a></li>
                    <li><a href="docoutbox.php">Outbox</a></li>
                    <!-- <li><a href="blood-bank.html">Blood Bank</a></li> -->
                  </ul>
                </li>
                <li><a href="appointmentview.php">APPOINTMENTS</a></li>
                <!-- <li><a href="receivemessage.php">Message</a></li> -->
               <!--  <li class="dropdown">
                ...
                <!-- </li> -->
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Consultancy <span class="fa fa-angle-down"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="consultingdetails.php">add</a></li>
                    <li><a href="consultancyedit.php">view</a></li>
